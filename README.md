...
This project utilizes the test-driven development (TDD) approach to implement a solver class with various methods.
...
```sh
  ...
  git clone https://github.com/Lornakaboro/TDD-project.git
```
...
- [ ] **Create more classes and add more tests**
...
Feel free to check the [issues page](https://github.com/Lornakaboro/TDD-project/issues).
